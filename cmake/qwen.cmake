...
add_library(freellm_lib STATIC
    src/qwen/storage.cpp src/qwen/metal.mm src/qwen/pressure.mm src/qwen/model.cpp src/qwen/prefill.cpp src/qwen/pipeline.cpp src/qwen/bench.cpp src/qwen/kernel_bench.cpp src/qwen/cached_replay.cpp
...
add_executable(qwen_q4_check scripts/qwen/check_q4.cpp)
target_link_libraries(qwen_q4_check PRIVATE freellm_lib)
...
add_executable(qwen_memory_check scripts/qwen/check_memory.cpp)
target_link_libraries(qwen_memory_check PRIVATE freellm_lib)
add_executable(qwen_q3_probe scripts/qwen/probe_q3.cpp)
target_link_libraries(qwen_q3_probe PRIVATE freellm_lib)
add_executable(qwen_submission_probe scripts/qwen/probe_submission.cpp)
target_link_libraries(qwen_submission_probe PRIVATE freellm_lib)
