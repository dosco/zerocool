...
struct Metal::Impl {
    ...
    uint64_t peak_groups=0,late_pipeline_creations=0;
...
void Metal::prepare_pipelines() {
    const char* mode=std::getenv("FREELLM_PIPELINE_PREWARM");
    ...
    static const std::set<std::string> selected={"affine_embedding","attention_scores","attention_softmax","attention_values","binary","conv","conv_update","copy_words","gather_rows","gdn_gate","gdn_qk","gdn_scan","hc_add","hc_mix","index_store","kv_store","moe_sum","mtp_wide_norm","norm","norm_rope","plain_mm","ple_gate","q4_gate_up","q4_gate_up_t4","q4_mm","q4_mm_t4","q8_expanded_t4_w8","q8_gate_up","q8_gate_up_t4","q8_mm","q8_mm_t2","q8_mm_t4","q8_mv_packed_r2_w4","q8_mv_packed_r2_w8","route_simd","router_accumulate","router_mm","scatter_experts","unary"};
    @autoreleasepool {
...
Json Metal::statistics() const {
    ...
    return {{"buffer_costs",impl_->accounting->costs?impl_->accounting->costs->json():Json(nullptr)},
        ...
        {"residency",impl_->residency->json()},{"kernels",impl_->config.json()},{"kernel_dispatches",impl_->kernel_counts},{"pipeline_preparation",{{"mode",impl_->prewarm_mode},{"prepared",impl_->prewarmed},{"available",[impl_->library.functionNames count]},{"live",[impl_->pipelines count]},{"late_creations",impl_->late_pipeline_creations}}},
        {"cpu_encode_ns",impl_->encode_ns},{"cpu_gpu_wait_ns",impl_->host_wait_ns},
