...
def run(output,directory,fixture_source,max_tokens=128,validation=False,validation_source=None):
    ...
    else:cases=workloads(ROOT/'.cache/qwen-mixed-reference',max_tokens)
...
if __name__=='__main__':
    ...
    if a.mode=='fixture':fixture(a.output,a.build)
        ...
        require(a.fixture is not None,'--fixture is required');run(a.output,a.build,a.fixture,a.max_tokens,a.mode=='validate',a.validation_source)
