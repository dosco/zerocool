...
Current experimental work: [bounded target state recovery, followed by measured draft-length selection](qwen_mtp_recovery_stage.md).
...
the recurrent scan alone is small. The [next small operator screen](benchmarks/2026-09-17-mtp-width-profile/next-protocol.md)
tests shared input/bias work across gate and up while preserving arithmetic.
