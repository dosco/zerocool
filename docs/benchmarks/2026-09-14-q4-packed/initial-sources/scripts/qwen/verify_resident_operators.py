...
def verify(directory, source_snapshot=None):
    ...
    for attempt in sorted(directory.iterdir()):
        ...
        if summary['kind'] == 'q8_lookahead_screen_v1':
            ...
            # Normal/traced request comparisons remain governed by the capture runner.
            # This audit reconstructs the dispatch split, not request/state qualification.
            ...
            row.update(recomputed_status='captured', result_qualified=False)
        else:
