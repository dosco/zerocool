...
void joint(const std::filesystem::path& model_path,const std::filesystem::path& prepared,const Json& input,
    ...
    report["admission"]={{"target",plan},{"draft_slots",32},{"draft_bytes",MtpDraft::budget_bytes(32,8192)},
        {"host_checkpoint_logits_bytes",host_bound},{"combined_bytes",combined},{"expert_scratch_reserve_bytes",mtp_scratch::ReserveBytes},{"target_recovery_reserve_bytes",mtp_recovery::ReserveBytes}};
...
int main(int argc,char** argv) {
    Json report={{"kind","native_mtp_width_v1"},{"complete",false},{"production_promoted",false}};bool write=false;
    try {
